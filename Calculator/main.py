...
btn_cl = tk.Button(root, text="CLEAR", command=clear_field, width=12, font=("Arial", 14))
btn_cl.grid(row=6, column=1, columnspan=2)

btn_eq = tk.Button(root, text="=", command=evaluate_calculation, width=12, font=("Arial", 14))
